...
def render_results():
    ...
    with col_ai:
        ...
        <div class="glass-card glass-card-accent">
          ...
          {"".join([f'<div class="ai-metric"><div class="val">{m["value"]}</div><div class="lbl">{m["label"]}</div></div>' for m in ai_text.get("metrics", [])]) and f'<div class="ai-metrics">{"".join([f\'<div class="ai-metric"><div class="val">{m["value"]}</div><div class="lbl">{m["label"]}</div></div>\' for m in ai_text.get("metrics", [])])}</div>' or ""}
          <div class="ai-text">
            <p>{ai_para1}</p>
            <p>{ai_para2}</p>
          </div>
